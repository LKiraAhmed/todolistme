                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                ...
                                <div class="d-flex justify-content-between col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    data-effect="effect-scale" data-toggle="modal" href="#modaldemo8"> ToDolist</a>

                                </div>
                                <form class="d-flex justify-content-end col-sm-6 col-md-8 col-xl-9" action="{{ route('section.search') }}" method="GET">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Update_Delete</th>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">update_section </h5>
